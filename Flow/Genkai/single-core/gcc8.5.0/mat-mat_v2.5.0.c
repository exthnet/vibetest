/* mat-mat_v2.5.0.c - AVX-512 8x8 micro-kernel (MR=8, NR=8) */
#include <stdio.h>
#include <stdlib.h>
#include <sys/time.h>
#include <immintrin.h>
...
// 8x8 AVX-512 micro-kernel: 8 rows x 8 cols = 8 x 512-bit registers
static inline void micro_kernel_8x8_avx512(int K, double *A, double *B, double *C, int ldc)
{
    ...
    for(int k=0; k<K; k++){
        ...
        __m512d a6 = _mm512_set1_pd(A[k*MR+6]);
        __m512d a7 = _mm512_set1_pd(A[k*MR+7]);
